...
//		updateNew.setCategoryCode(oldNew.getCategoryCode());
...
//		updateNew.setModifiedBy(oldNew.getModifiedBy());
		...
		System.out.println("Service:"+ updateNew.getCategoryCode());
		System.out.println("Service:"+ updateNew.getTitle());
		System.out.println("Service:"+ updateNew.getShortDescription());
		System.out.println("Service:"+ updateNew.getContent());
		System.out.println("Service:"+ updateNew.getCategoryId());
	...
	@Override
	public List<NewModel> findAllNoPageble() {
		// TODO Auto-generated method stub
		return newDao.findAllNoPageble();
	}
