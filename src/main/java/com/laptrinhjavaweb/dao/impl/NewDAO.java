...
public class NewDAO extends AbstractDAO<NewModel> implements INewDAO {
	...
	public void update(NewModel updateNew) {
		System.out.println("DAO Id:"+ updateNew.getId());
		System.out.println("DAO:"+ updateNew.getCategoryCode());
		System.out.println("DAO:"+ updateNew.getTitle());
		System.out.println("DAO:"+ updateNew.getShortDescription());
		System.out.println("DAO:"+ updateNew.getContent());
		System.out.println("DAO:"+ updateNew.getCategoryId());
